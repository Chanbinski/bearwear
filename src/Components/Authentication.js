            ...
            <div>
                <div className="flex flex-col justify-center items-center mt-48">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-center mt-6">
                        <img className="w-1/3 lg:w-1/6" src={process.env.PUBLIC_URL + '/bearwear_logo.png'} />
                        <div className="p-5 lg:p-10 w-1/4 flex flex-col justify-center items-center mb-5">
                            <button 
                                className="mt-2 w-48 lg:w-3/4 p-2 border rounded-3xl text-center"
                                onClick={()=>{setClickedSignUp(true)}}
                            >
                                Sign Up
                            </button>
                            <div className="mt-5 w-48 text-center text-xs text-slate-500">If you already have an account</div>
                            <button 
                                className="mt-2 w-48 lg:w-3/4 p-2 border rounded-3xl text-center"
